...
MOVES_CATALOGUE: dict[str, list[ActiveSkill]] = {
    "Powerhouse": [
        ActiveSkill("Vertical Suplex", 15, 0.90),
        ActiveSkill("Spinebuster", 18, 1.05),
        ActiveSkill("Military Press", 20, 1.10),
        ActiveSkill("Powerslam", 15, 1.00),
        ActiveSkill("Big Boot", 10, 0.85),
        ActiveSkill("Clothesline from Hell", 22, 1.20),
        ActiveSkill("Backbreaker", 17, 1.05),
        ActiveSkill("Bearhug", 12, 0.80),
        ActiveSkill("Fallaway Slam", 16, 1.00),
        ActiveSkill("Shoulder Tackle", 10, 0.85),
    ],
    "HighFlyer": [
        ActiveSkill("Dropkick", 12, 0.85),
        ActiveSkill("Hurricanrana", 15, 1.00),
        ActiveSkill("Moonsault", 22, 1.20),
        ActiveSkill("Enzuigiri", 18, 1.05),
        ActiveSkill("Springboard Forearm", 20, 1.10),
        ActiveSkill("Tornado DDT", 17, 1.05),
        ActiveSkill("Crossbody", 14, 0.90),
        ActiveSkill("Standing Shooting Star", 25, 1.25),
        ActiveSkill("Handspring Elbow", 15, 1.00),
        ActiveSkill("619 Kick", 20, 1.10),
    ],
    "Technician": [
        ActiveSkill("Arm Bar", 10, 0.80),
        ActiveSkill("German Suplex", 18, 1.10),
        ActiveSkill("Dragon Screw", 12, 0.90),
        ActiveSkill("Cobra Twist", 15, 1.00),
        ActiveSkill("Northern Lights Suplex", 17, 1.05),
        ActiveSkill("Crossface", 20, 1.20),
        ActiveSkill("Ankle Lock", 18, 1.05),
        ActiveSkill("Exploder Suplex", 16, 1.00),
        ActiveSkill("Sharpshooter", 22, 1.25),
        ActiveSkill("Fujiwara Armbar", 15, 1.00),
    ],
}
